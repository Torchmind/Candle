...
public class IntegerArrayPropertyNode extends AbstractArrayPropertyNode implements IIntegerArrayPropertyNode {
        ...
        @Nonnull
        @Override
        public IntegerArrayPropertyNode accept (@Nonnull IVisitor visitor) {
                super.accept (visitor);

                visitor.visitArray ();

                for (int current : this.array ()) {
                        visitor.visitInteger (current);
                }
        ...
        @Nonnull
        @Override
        public IntegerArrayPropertyNode accept (@Nonnull ITreeVisitor visitor) {
                super.accept (visitor);
